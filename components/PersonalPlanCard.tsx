import { Droplets, Scale, Target, TrendingUp } from "lucide-react";
      ...
      <div className="relative space-y-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-xl">
            ...
            <p className="mt-1 max-w-lg text-sm text-textoSec dark:text-muted-foreground">
              {getGoalTypeDescription(profile.goalType)}
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-3 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[24px] border border-white/65 bg-white/58 p-4 backdrop-blur dark:border-white/10 dark:bg-black/10">
            <div className="flex items-center justify-between gap-2">
              <p className="text-sm font-semibold text-textoPrim dark:text-foreground">Seu ciclo pessoal</p>
          ...
          <div className="rounded-[24px] border border-white/65 bg-[#351f2f]/95 p-4 text-white shadow-[0_14px_30px_-22px_rgba(53,31,47,0.9)] dark:border-white/10 dark:bg-[#251923]/92">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/60">foco do dia</p>
            <p className="mt-3 text-lg font-bold leading-snug">
              {profile.focus ?? "Defina em Config o foco que vai guiar suas escolhas de hoje."}
            </p>
            <div className="mt-4 rounded-2xl bg-white/10 p-3">
              ...
              <p className="mt-3 inline-flex items-center gap-2 text-sm font-medium text-white/80">
                ...
                {todayCheckIn?.waterGlasses ?? 0} de {profile.dailyWaterGoal} copos registrados
              </p>
